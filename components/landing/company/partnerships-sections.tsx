...
const partnerTypes = [
  {
    icon: Building2,
    title: "Agrovet & Supplier Partners",
    desc: "List your products on our marketplace, reach 50K+ farmers, and manage orders digitally. Free onboarding and marketing support.",
    benefits: ["Free digital storefront", "Order management tools", "Farmer analytics dashboard", "Marketing co-promotion"],
  },
  {
    icon: Landmark,
    title: "Financial Institutions",
    desc: "Access AI-scored farmers with verified performance data. Reduce defaults with data-driven lending and automated disbursement.",
    benefits: ["Pre-scored farmer profiles", "Portfolio monitoring", "M-Pesa disbursement", "Risk analytics API"],
  },
  {
    icon: Tractor,
    title: "Equipment & Input Manufacturers",
    desc: "Reach smallholder farmers directly through our marketplace. Run targeted campaigns and sponsorships.",
    benefits: ["Direct farmer access", "Product sampling programs", "Brand sponsorships", "Market intelligence data"],
  },
  {
    icon: Globe,
...
export function PartnershipsStatsSection() {
  return (
...
export function PartnershipsProgramsSection() {
  return (
    <section className="py-20 bg-slate-50 dark:bg-slate-950">
      <div className="container mx-auto px-4 max-w-7xl">
        ...
        <div className="grid md:grid-cols-2 gap-6">
          {partnerTypes.map((p) => (
            <Card key={p.title} className="group hover:shadow-xl transition-shadow bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 hover:border-green-400">
              <CardContent className="p-6">
                <div className="flex items-start gap-4">
                  <div className="w-14 h-14 rounded-2xl bg-green-100 dark:bg-green-900/30 flex items-center justify-center flex-shrink-0 group-hover:scale-110 transition-transform">
                    <p.icon className="w-7 h-7 text-green-600 dark:text-green-400" />
                  </div>
...
export function PartnershipsNetworkSection() {
  return (
...
export function PartnershipsWhySection() {
  return (
    <section className="py-20 bg-slate-50 dark:bg-slate-950">
      <div className="container mx-auto px-4 max-w-7xl">
        <div className="bg-gradient-to-r from-green-50 to-emerald-50 dark:from-green-700 dark:to-emerald-600 rounded-3xl p-8 lg:p-12 border border-green-200 dark:border-transparent">
          <div className="grid lg:grid-cols-2 gap-8 items-center">
            ...
            <div className="grid grid-cols-2 gap-4">
              {whyStats.map(({ icon: Icon, val, label }) => (
