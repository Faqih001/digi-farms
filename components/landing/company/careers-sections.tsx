    ...
    <section className="gradient-hero py-20 lg:py-28">
      <div className="container mx-auto px-4 max-w-7xl text-center">
        ...
        <h1 className="text-4xl lg:text-6xl font-black text-white mb-6 leading-tight">
          ...
          <span className="text-green-200">African Agriculture</span>
        </h1>
    ...
    <section className="py-20 bg-white dark:bg-slate-900">
      <div className="container mx-auto px-4 max-w-7xl">
        ...
        <div className="grid sm:grid-cols-3 gap-6">
          {cultureValues.map((v) => (
            <Card key={v.title} className="text-center border-0 shadow-lg bg-white dark:bg-slate-800 hover:shadow-xl transition-shadow">
...
export function CareersPerksSection() {
  return (
    <section
          ...
          {perks.map((p) => (
            <div key={p.title} className="flex items-start gap-4 p-5 rounded-xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800">
              <div className="w-10 h-10 rounded-xl bg-green-100 dark:bg-green-900/30 flex items-center justify-center flex-shrink-0">
                <p.icon className="w-5 h-5 text-green-600 dark:text-green-400" />
              </div>
              <div>
      ...
      <div className="container mx-auto px-4 max-w-4xl">
        ...
        <div className="space-y-3">
          {openRoles.map((role) => (
            <div
              key={role.title}
              className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 p-5 rounded-xl bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 hover:border-green-400 transition-colors group"
            >
              <div>
