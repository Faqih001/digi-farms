    ...
    <section className="py-20 bg-white dark:bg-slate-900">
      <div className="container mx-auto px-4 max-w-7xl">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {leadership.map((m) => (
            <Card key={m.name} className="group hover:shadow-xl transition-shadow bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700">
              <CardContent className="p-6 text-center">
                ...
                <p className="text-sm font-medium text-green-600 dark:text-green-400 mb-3">{m.role}</p>
...
export function TeamAdvisorsSection() {
  return (
    <section className="py-20 bg-slate-50 dark:bg-slate-950">
      <div className="container mx-auto px-4 max-w-7xl">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {advisors.map((a) => (
            <Card key={a.name} className="text-center bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 hover:shadow-lg transition-shadow">
...
export function TeamDepartmentsSection() {
  return (
    <section className="py-20 bg-white dark:bg-slate-900">
      <div className="container mx-auto px-4 max-w-7xl">
        <div className="text-center mb-14">
