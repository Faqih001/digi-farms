    ...
    <section className="gradient-hero py-20 lg:py-24">
      <div className="container mx-auto px-4 max-w-7xl text-center">
        ...
        <h1 className="text-4xl lg:text-6xl font-black text-white mb-6 leading-tight">
          Insights & <span className="text-green-200">Stories</span>
        </h1>
            ...
            <button
              ...
              className={`flex items-center gap-1.5 px-4 py-2 rounded-full text-sm font-medium transition-all ${
                i === 0
                  ...
                  : "bg-slate-100 dark:bg-slate-800 text-slate-600 dark:text-slate-300 hover:bg-green-50 dark:hover:bg-green-950/50"
              }`}
            >
  ...
  return (
    <section className="py-16 bg-white dark:bg-slate-900">
      <div className="container mx-auto px-4 max-w-7xl">
        <Card className="overflow-hidden border-0 shadow-xl bg-white dark:bg-slate-800 hover:shadow-2xl transition-shadow">
          <CardContent className="p-0">
            <div className="grid lg:grid-cols-2 gap-0">
              <div className="bg-gradient-to-br from-green-100 to-emerald-100 dark:from-green-700 dark:to-emerald-600 p-8 lg:p-12 flex items-center">
                <div>
              ...
              <div className="p-8 lg:p-12 flex flex-col justify-center bg-white dark:bg-slate-800">
                <div className="flex items-center gap-4 mb-6">
                  <div className="w-12 h-12 rounded-full bg-green-100 dark:bg-green-900/30 flex items-center justify-center text-green-600 dark:text-green-400 font-bold">NB</div>
                  <div>
    ...
    <section className="py-16 bg-slate-50 dark:bg-slate-950">
      <div className="container mx-auto px-4 max-w-7xl">
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {posts.map((post) => (
            <Card key={post.title} className="group hover:shadow-xl transition-shadow bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 overflow-hidden">
              <CardContent className="p-0">
