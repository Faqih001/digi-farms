...
import {
  ...
  Search, ShoppingCart, CreditCard, Leaf,
    ...
    <section className="gradient-hero py-20 lg:py-28">
      <div className="container mx-auto px-4 max-w-7xl text-center">
        ...
        <h1 className="text-4xl lg:text-6xl font-black text-white mb-6 leading-tight">
          ...
          <span className="text-green-200">Help You?</span>
        </h1>
    ...
    <section className="py-20 bg-white dark:bg-slate-900">
      <div className="container mx-auto px-4 max-w-7xl">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {faqCategories.map((c) => (
            <Card key={c.title} className="group hover:shadow-xl transition-shadow bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 hover:border-green-400 cursor-pointer">
      ...
      <div className="container mx-auto px-4 max-w-7xl">
        ...
        <div className="grid sm:grid-cols-3 gap-6 max-w-4xl mx-auto">
          {contactOptions.map((c) => (
            <Card key={c.title} className="group hover:shadow-xl transition-shadow bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 hover:border-green-400 text-center">
              <CardContent className="p-6">
                <div className={`w-14 h-14 rounded-2xl ${c.color} flex items-center justify-center mx-auto mb-4 group-hover:scale-110 transition-transform`}>
                  <c.icon className="w-7 h-7 text-green-600 dark:text-green-400" />
                </div>
                ...
                <p className="text-xs text-green-600 dark:text-green-400 font-medium">{c.detail}</p>
              </CardContent>
            </Card>
          ))}
        </div>
