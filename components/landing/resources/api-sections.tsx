...
export function ApiFeaturesSection() {
  return (
    <section className="py-20 bg-white dark:bg-slate-900">
      <div className="container mx-auto px-4 max-w-7xl">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {features.map((f) => (
            <Card key={f.title} className="group hover:shadow-xl transition-shadow bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 hover:border-green-400">
      ...
      <div className="container mx-auto px-4 max-w-4xl">
        ...
        <Card className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800">
          <CardContent className="p-6">
            ...
            <p className="text-xs text-slate-400 mt-3">Generate API keys from your dashboard under Settings → API Keys.</p>
          </CardContent>
        </Card>
      </div>
    </section>
...
export function ApiSDKsSection() {
  return (
    <section className="py-20 bg-slate-50 dark:bg-slate-950">
      <div className="container mx-auto px-4 max-w-4xl">
        ...
        <div className="grid sm:grid-cols-3 gap-4">
          {sdks.map((s) => (
            <Card key={s.lang} className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 hover:border-green-400 transition-colors">
