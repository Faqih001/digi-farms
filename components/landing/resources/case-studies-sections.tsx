...
export function CaseStudiesStatsSection() {
  return (
      ...
      <div className="container mx-auto px-4 max-w-5xl">
        <div className="space-y-8">
          {caseStudies.map((cs, i) => (
            <Card key={i} className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 overflow-hidden hover:shadow-xl transition-shadow">
                ...
                <div className="grid lg:grid-cols-3">
                  <div className="lg:col-span-2 p-6 lg:p-8">
                    ...
                    <div className="flex flex-wrap gap-4 mb-4">
                      {cs.metrics.map((m) => (
                        <div key={m.label} className="text-center px-3 py-2 bg-green-50 dark:bg-green-900/20 rounded-xl">
                          <div className="text-lg font-black text-green-600 dark:text-green-400">{m.value}</div>
                    ...
                    <div className="border-l-4 border-green-500 pl-4">
                      ...
                      <p className="text-xs text-green-600 dark:text-green-400 font-medium mt-1">— {cs.author}</p>
                    </div>
                  </div>
