            ...
            <div className="bg-white dark:bg-slate-900 rounded-2xl border border-slate-200 dark:border-slate-700 p-6 shadow-lg">
              <div className="flex items-center gap-3 mb-5">
                ...
                <div>
                  ...
                  <div className="text-xs text-green-600">● Model v2.4 · Active</div>
                </div>
              </div>
        ...
        <div className="container mx-auto px-4 max-w-7xl">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              { icon: Cloud, title: "Water Stress Detection", desc: "Thermal infrared imaging detects water stress 7–14 days before wilting occurs, enabling proactive irrigation.", color: "text-cyan-600" },
