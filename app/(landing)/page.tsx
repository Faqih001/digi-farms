      ...
      <div className="container mx-auto px-4 max-w-7xl py-24 relative z-10">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="animate-fade-up">
            ...
            <p className="text-lg text-green-900 dark:text-green-100/80 leading-relaxed mb-8 max-w-lg">
            ...
            <div className="flex items-center gap-6 text-sm text-green-800 dark:text-green-200/70">
          ...
          <div className="animate-fade-up delay-200 hidden lg:block">
            <div className="glass-card p-6 border border-green-200 dark:border-white/20 bg-white/80 dark:bg-white/10 backdrop-blur-xl">
              <div className="flex items-center justify-between mb-4">
                <div>
                  <p className="text-green-600 dark:text-green-300 text-xs font-semibold uppercase tracking-wider mb-0.5">Farm Dashboard</p>
              ...
              <div className="grid grid-cols-2 gap-3 mb-4">
                {[
                  ...
                  <div key={stat.label} className="bg-green-50 dark:bg-white/10 rounded-xl p-3.5 backdrop-blur-sm">
                    <div className="text-xl mb-1">{stat.icon}</div>
                    <div className="text-slate-900 dark:text-white font-bold text-lg leading-none">{stat.value}</div>
                    <div className="text-green-600 dark:text-green-300 text-xs mt-0.5">{stat.label}</div>
                    <div className="text-green-600 dark:text-green-400 text-xs font-semibold mt-1">{stat.trend}</div>
                  </div>
                ))}
              </div>

              <div className="bg-green-50 dark:bg-white/10 rounded-xl p-3.5 backdrop-blur-sm">
                <div className="flex items-center justify-between mb-2">
                  <span className="text-green-600 dark:text-green-300 text-xs font-semibold">AI Diagnostics — Last Scan</span>
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <div className="text-slate-500 dark:text-green-300/70 text-xs">Maize field — Block 2A · No disease detected</div>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="mt-20 grid grid-cols-2 sm:grid-cols-4 gap-6">
          {[
            ...
            <div key={stat.label} className="text-center">
              ...
              <div className="text-green-700 dark:text-green-300/70 text-sm">{stat.label}</div>
            </div>
          ))}
        </div>
      </div>
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="bg-gradient-to-br from-green-500 to-green-700 dark:from-green-700 dark:to-green-900 rounded-3xl p-8 text-white shadow-2xl">
            <div className="text-center mb-8">
              ...
              <p className="text-green-200 dark:text-green-300 text-sm">Precision Agriculture Platform</p>
            </div>
            ...
            <div className="grid grid-cols-2 gap-4">
              {[
                ...
                <div key={label} className="bg-white/20 rounded-xl p-3 backdrop-blur-sm flex items-center gap-3">
                  <span className="text-2xl">{emoji}</span>
                  <div>
                    <div className="text-sm font-bold">{label}</div>
                    <div className="text-xs text-green-200 dark:text-green-300">{desc}</div>
                  </div>
                </div>
              ))}
            </div>
    ...
    <section className="py-24 bg-gradient-to-br from-green-50 to-emerald-100 dark:from-green-900 dark:to-green-950 text-slate-800 dark:text-white">
      <div className="container mx-auto px-4 max-w-7xl">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          {/* Financing card */}
          <div className="glass rounded-2xl p-8 bg-white/80 dark:bg-white/10 border border-green-100 dark:border-white/20">
  ...
  return (
    <section className="py-24 gradient-mesh">
      <div className="container mx-auto px-4 max-w-4xl text-center">
        <Badge className="mb-6 bg-green-600/10 text-green-800 border-green-200 dark:bg-white/20 dark:text-white dark:border-white/30 text-sm px-4 py-1.5">
          🚀 Join 50,000+ Farmers
        </Badge>
        ...
        <p className="text-xl text-green-800 dark:text-green-200/80 mb-10 leading-relaxed">
        ...
        <div className="mt-16 pt-10 border-t border-green-200 dark:border-white/20">
          <p className="text-green-700 dark:text-green-200/60 text-sm mb-4">📬 Subscribe to AgriIntelligence Weekly</p>
          <form className="flex gap-3 max-w-md mx-auto">
            <input
              type="email"
              placeholder="your@email.com"
              className="flex-1 h-12 px-4 rounded-xl bg-green-50 dark:bg-white/10 border border-green-200 dark:border-white/20 text-slate-900 dark:text-white placeholder:text-green-500 dark:placeholder:text-green-200/50 focus:outline-none focus:ring-2 focus:ring-green-400 dark:focus:ring-white/30 backdrop-blur-sm text-sm"
            />
            <Button variant="hero" size="lg" type="submit">Subscribe</Button>
          </form>
          <p className="text-green-600 dark:text-green-200/40 text-xs mt-3">Join 28,000+ subscribers. No spam, ever.</p>
        </div>
      </div>
    </section>
  );
