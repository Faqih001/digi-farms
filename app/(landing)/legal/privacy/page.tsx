    ...
    <>
      ...
      <section className="gradient-hero py-20 lg:py-24">
        <div className="container mx-auto px-4 max-w-7xl text-center">
          ...
          <h1 className="text-4xl lg:text-5xl font-black text-slate-900 dark:text-white mb-4 leading-tight">Privacy Policy</h1>
      ...
      {/* Navigation */}
      <section style={{ backgroundColor: "#fff", color: "#0f172a" }} className="py-6 bg-white dark:bg-slate-900 border-b border-slate-200 dark:border-slate-800 sticky top-0 z-10">
        ...
        <div className="container mx-auto px-4 max-w-7xl">
          ...
          <div className="text-center mt-8">
            <p className="text-sm text-slate-500 dark:text-slate-400">
              See also: <Link href="/legal/terms" className="text-green-600 hover:underline">Terms of Service</Link> · <Link href="/legal/cookies" className="text-green-600 hover:underline">Cookie Policy</Link> · <Link href="/legal/dpa" className="text-green-600 hover:underline">Data Processing Agreement</Link>
            </p>
          </div>
        </div>
      </section>
