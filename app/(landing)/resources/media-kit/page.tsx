    ...
    <>
      ...
      <section id="assets" className="py-20 bg-slate-50 dark:bg-slate-950 scroll-mt-20">
        <div className="container mx-auto px-4 max-w-7xl">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {brandAssets.map((a) => (
              <Card key={a.title} className="group hover:shadow-xl transition-shadow dark:bg-slate-900 border-slate-200 dark:border-slate-800 hover:border-green-400 cursor-pointer">
                <CardContent className="p-6 text-center">
                  <div className="w-14 h-14 rounded-2xl bg-green-100 dark:bg-green-900/30 flex items-center justify-center mx-auto mb-4 group-hover:scale-110 transition-transform">
                    <a.icon className="w-7 h-7 text-green-600" />
                  </div>
        ...
        <div className="container mx-auto px-4 max-w-4xl">
          ...
          <div className="space-y-4">
            {pressReleases.map((pr, i) => (
              <Card key={i} className="dark:bg-slate-900 border-slate-200 dark:border-slate-800 hover:border-green-400 transition-colors cursor-pointer group">
      ...
      <section className="py-20 bg-gradient-to-br from-green-50 to-emerald-100 dark:from-green-800 dark:to-green-950">
        <div className="container mx-auto px-4 max-w-3xl text-center">
          <Globe className="w-14 h-14 text-green-600 dark:text-green-600 dark:text-green-300 mx-auto mb-4" />
