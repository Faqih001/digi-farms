...
const gettingStarted = [
  { icon: Rocket, title: "Quick Start Guide", desc: "Set up your account, complete verification, and make your first transaction in under 10 minutes.", time: "10 min", href: "#" },
  { icon: ShoppingCart, title: "Marketplace Guide", desc: "Learn how to browse products, compare suppliers, place orders, and track deliveries.", time: "15 min", href: "#" },
  { icon: BarChart3, title: "Farm Analytics Setup", desc: "Connect your farm data, set up monitoring dashboards, and configure alerts.", time: "20 min", href: "#" },
  { icon: Wallet, title: "Payments & Financing", desc: "Understand M-Pesa integration, apply for farm loans, and manage your wallet.", time: "12 min", href: "#" },
];

const docCategories = [
  { icon: Smartphone, title: "Platform Guides", count: 24, desc: "Step-by-step guides for every platform feature.", color: "bg-blue-100 dark:bg-blue-900/30 text-blue-600" },
  { icon: Code, title: "API Documentation", count: 40, desc: "REST API endpoints, authentication, and examples.", color: "bg-purple-100 dark:bg-purple-900/30 text-purple-600" },
  { icon: Shield, title: "Security & Compliance", count: 8, desc: "Data protection, privacy settings, and account security.", color: "bg-red-100 dark:bg-red-900/30 text-red-600" },
  { icon: Leaf, title: "Best Practices", count: 16, desc: "Maximize yields and profitability with expert tips.", color: "bg-green-100 dark:bg-green-900/30 text-green-600" },
  { icon: ShoppingCart, title: "Seller Guides", count: 12, desc: "For suppliers and agrovets listing on the marketplace.", color: "bg-orange-100 dark:bg-orange-900/30 text-orange-600" },
  { icon: BarChart3, title: "Reporting & Analytics", count: 10, desc: "Custom reports, data exports, and integrations.", color: "bg-teal-100 dark:bg-teal-900/30 text-teal-600" },
];
        ...
        <div className="container mx-auto px-4 max-w-7xl">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {gettingStarted.map((g) => (
              <Card key={g.title} className="group hover:shadow-xl transition-shadow dark:bg-slate-800 border-slate-200 dark:border-slate-700 hover:border-green-400">
                <CardContent className="p-6">
                  <div className="w-12 h-12 rounded-2xl bg-green-100 dark:bg-green-900/30 flex items-center justify-center mb-4 group-hover:scale-110 transition-transform">
                    <g.icon className="w-6 h-6 text-green-600" />
                  </div>
      ...
      <section className="py-20 bg-slate-50 dark:bg-slate-950">
        <div className="container mx-auto px-4 max-w-7xl">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {docCategories.map((c) => (
              <Card key={c.title} className="group hover:shadow-xl transition-shadow dark:bg-slate-900 border-slate-200 dark:border-slate-800 hover:border-green-400 cursor-pointer">
                <CardContent className="p-6">
