  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-sm text-slate-500">Track your earnings and financial performance</p>
      </div>
            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="border-b border-slate-200 dark:border-slate-700">
                  <th className="text-left p-3 font-semibold text-slate-500 text-xs uppercase">Month</th>
                  <th className="text-left p-3 font-semibold text-slate-500 text-xs uppercase">Revenue</th>
                  <th className="text-left p-3 font-semibold text-slate-500 text-xs uppercase">Orders</th>
                  <th className="text-left p-3 font-semibold text-slate-500 text-xs uppercase">Growth</th>
                </tr>
              </thead>
              <tbody>
                {monthlyRevenue.map((m) => (
                  <tr key={m.month} className="border-b border-slate-100 dark:border-slate-800">
                    ...
                    <td className="p-3 text-slate-500">{m.orders}</td>
                    <td className="p-3">
          ...
          <div className="grid sm:grid-cols-3 gap-4">
            {[
              ...
              <div key={method} className="p-4 bg-slate-50 dark:bg-slate-800 rounded-xl text-center">
                ...
                <p className="text-xs text-slate-500">{amount} this month</p>
              </div>
            ))}
          </div>
        </CardContent>
